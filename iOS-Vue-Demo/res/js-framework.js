...
)("START JS FRAMEWORK 0.29.7, Build 2020-07-30 13:57. (Vue: 2.5.16-weex.5, Rax: 0.4.20)");
var global = this;
var process = { env: {} };
...
(function(global, factory) {
  ...
  if (typeof WXEnvironment$1 !== "undefined" && (WXEnvironment$1.platform === "iOS" || WXEnvironment$1.platform === "android") && !WXEnvironment$1.__enable_native_promise__) {
  ...
  for (var collections = _objectKeys(DOMIterables), i = 0; i < collections.length; i++) {
    ...
    if (proto) {
      if (!proto[ITERATOR$1]) {
        _hide(proto, ITERATOR$1, ArrayValues);
      }
  ...
  function bufferToBase64(buffer) {
    ...
    var string = Array.prototype.map
      .call(new Uint8Array(buffer), function(code) {
    ...
    if (global.WXEnvironment && global.WXEnvironment.platform !== "Web") {
      global.console = {
        debug: function() {
          ...
          if (checkLevel("debug")) {
            global.nativeLog.apply(global, format(args).concat(["__DEBUG"]));
          }
        },
        log: function() {
          var args = [],
          ...
          if (checkLevel("log")) {
            global.nativeLog.apply(global, format(args).concat(["__LOG"]));
          }
        },
        info: function() {
          var args = [],
          ...
          if (checkLevel("info")) {
            global.nativeLog.apply(global, format(args).concat(["__INFO"]));
          }
        },
        warn: function() {
          var args = [],
          ...
          if (checkLevel("warn")) {
            global.nativeLog.apply(global, format(args).concat(["__WARN"]));
          }
        },
        error: function() {
          var args = [],
          ...
          if (checkLevel("error")) {
            global.nativeLog.apply(global, format(args).concat(["__ERROR"]));
          }
        },
      };
    }
  ...
  var subversion = { framework: "0.29.7", transformer: ">=0.1.5 <0.5" };
  ...
  var Element = (function(Node$$1) {
    ...
    Element.prototype.appendChild = function appendChild(node) {
      ...
      if (!node.parentNode) {
        if (checkLevel("debug")) {
          debugLog("[appendChild](" + this.docId + "," + node.type + "," + node.ref + ") " + "Append <" + node.type + "> to <" + this.type + "> (" + this.ref + ").");
        }
        ...
        if (node.nodeType === 1) {
          ...
          var taskCenter = getTaskCenter(this.docId);
          if (taskCenter) {
            return taskCenter.send("dom", { action: "addElement" }, [this.ref, node.toJSON(), -1]);
          }
        }
      } else {
        if (checkLevel("debug")) {
          debugLog("[appendChild](" + this.docId + "," + node.type + "," + node.ref + ") " + "Move <" + node.type + "> to " + this.children.length + " of <" + this.type + "> (" + this.ref + ").");
        }
        ...
        if (node.nodeType === 1) {
          ...
          if (taskCenter$1 && index >= 0) {
            return taskCenter$1.send("dom", { action: "moveElement" }, [node.ref, this.ref, index]);
          }
        }
      }
    };
    ...
    Element.prototype.insertBefore = function insertBefore(node, before) {
      ...
      if (!node.parentNode) {
        if (checkLevel("debug")) {
          debugLog("[insertBefore](" + this.docId + "," + node.type + "," + node.ref + ") " + "Insert <" + node.type + "> to <" + this.type + "> (" + this.ref + "), before (" + before.ref + ").");
        }
        linkParent(node, this);
        ...
        if (node.nodeType === 1) {
          ...
          var taskCenter = getTaskCenter(this.docId);
          if (taskCenter) {
            return taskCenter.send("dom", { action: "addElement" }, [this.ref, node.toJSON(), index]);
          }
        }
      } else {
        ...
        if (node.nodeType === 1) {
          ...
          /* istanbul ignore next */
          var index$1 = moveIndex(node, this.pureChildren, pureBefore$1 ? this.pureChildren.indexOf(pureBefore$1) : this.pureChildren.length);
          var taskCenter$1 = getTaskCenter(this.docId);
          if (taskCenter$1 && index$1 >= 0) {
            return taskCenter$1.send("dom", { action: "moveElement" }, [node.ref, this.ref, index$1]);
          }
        }
      }
    };
    ...
    Element.prototype.insertAfter = function insertAfter(node, after) {
      ...
      if (!node.parentNode) {
        if (checkLevel("debug")) {
          debugLog("[insertAfter](" + this.docId + "," + node.type + "," + node.ref + ") " + "Insert <" + node.type + "> to <" + this.type + "> (" + this.ref + "), after (" + after.ref + ").");
        }
        linkParent(node, this);
        ...
        if (node.nodeType === 1) {
          var index$1 = moveIndex(node, this.pureChildren, this.pureChildren.indexOf(previousElement(after)) + 1);
          var taskCenter$1 = getTaskCenter(this.docId);
          if (taskCenter$1 && index$1 >= 0) {
            return taskCenter$1.send("dom", { action: "moveElement" }, [node.ref, this.ref, index$1]);
          }
    ...
    Element.prototype.removeChild = function removeChild(node, preserved) {
      if (node.parentNode) {
        ...
        if (node.nodeType === 1) {
          if (checkLevel("debug")) {
            debugLog("[removeChild](" + this.docId + "," + node.type + "," + node.ref + ") " + "Remove <" + node.type + "> from <" + this.type + "> (" + this.ref + ").");
          }
    ...
    Element.prototype.setAttrs = function setAttrs(batchedAttrs, silent) {
      ...
      if (!isEmpty(mutations)) {
        var taskCenter = getTaskCenter(this.docId);
        if (!silent && taskCenter) {
          taskCenter.send("dom", { action: "updateAttrs" }, [this.ref, mutations]);
        }
      }
    };
    ...
    Element.prototype.setStyles = function setStyles(batchedStyles, silent) {
                 console.log(`setStyles: ${batchedStyles.width}`);
      var this$1 = this;
      ...
      if (!isEmpty(mutations)) {
        var taskCenter = getTaskCenter(this.docId);
        if (!silent && taskCenter) {
          taskCenter.send("dom", { action: "updateStyle" }, [this.ref, mutations]);
        }
      }
    };
    ...
    Element.prototype.addEvent = function addEvent(type, handler, params) {
      ...
      if (!this.event[type]) {
        if (checkLevel("debug")) {
          debugLog("[addEvent](" + this.docId + "," + this.type + "," + this.ref + ") " + 'Add "' + type + '" event on <' + this.type + "> (" + this.ref + ").");
        }
        this.event[type] = { handler: handler, params: params };
        var taskCenter = getTaskCenter(this.docId);
        if (taskCenter) {
          taskCenter.send("dom", { action: "addEvent" }, [this.ref, type]);
        }
      }
    };
    ...
    Element.prototype.removeEvent = function removeEvent(type) {
      if (this.event && this.event[type]) {
        if (checkLevel("debug")) {
          debugLog("[removeEvent](" + this.docId + "," + this.type + "," + this.ref + ") " + 'Remove "' + type + '" event on <' + this.type + "> (" + this.ref + ").");
        }
        delete this.event[type];
        var taskCenter = getTaskCenter(this.docId);
        if (taskCenter) {
          taskCenter.send("dom", { action: "removeEvent" }, [this.ref, type]);
        }
      }
    };
    ...
    Element.prototype.fireEvent = function fireEvent(type, event, isBubble, options) {
      ...
      if (eventDesc && event) {
        if (checkLevel("debug")) {
          debugLog("[fireEvent](" + this.docId + "," + this.type + "," + this.ref + ") " + 'Fire "' + type + '" event on <' + this.type + "> (" + this.ref + ").");
        }
        ...
        try {
          ...
          console.error('[JS Framework] Failed to invoke the event handler of "' + type + '" ' + "on " + this.type + " (" + this.ref + "):\n " + error.toString());
          throw error;
        }
      }

      if (!isStopPropagation && isBubble && BUBBLE_EVENTS.indexOf(type) !== -1 && this.parentNode && this.parentNode.fireEvent) {
    ...
    if (deep) {
      ...
      if (type === "Array") {
        return v.map(function(item) {
          return this$1.normalize(item, true);
        });
      }
    }
  ...
  function receiveTasks(id, tasks) {
   console.log(`收到事件3: ${id}, ${tasks}`);
    var document = getDoc(id);
    if (!document) {
      return new Error("[JS Framework] Failed to receiveTasks, " + "instance (" + id + ") is not available.");
    }
    ...
    if (Array.isArray(tasks)) {
      return tasks.map(function(task) {
        switch (task.method) {
          case "callback":
            return callback.apply(void 0, [document].concat(task.args));
          case "fireEventSync":
          case "fireEvent":
            return fireEvent.apply(void 0, [document].concat(task.args));
          case "componentHook":
            return componentHook.apply(void 0, [document].concat(task.args));
        }
      });
    }
  }
  ...
  function hasAvailableHandler(module, method) {
    return module === "dom" && handlerMap[method] && typeof global[handlerMap[method]] === "function";
  }
  ...
  Document.prototype.createBody = function createBody(type, props) {
    if (!this.body) {
      ...
      setBody(this, el);
      if (checkLevel("debug")) {
        debugLog("[createBody](" + this.id + "," + el.type + "," + el.ref + ") " + "(" + JSON.stringify(el.toJSON(true)) + ").");
      }
    }
  ...
  Document.prototype.createElement = function createElement(tagName, props) {
    ...
    if (checkLevel("debug")) {
      debugLog("[createElement](" + this.id + "," + el.type + "," + el.ref + ") " + "(" + JSON.stringify(el.toJSON(true)) + ").");
    }
    return el;
  };
  ...
  Document.prototype.destroy = function destroy() {
    if (checkLevel("debug")) {
      debugLog("[destroy](" + this.id + ",document," + this.ref + ") " + 'Destroy document (id: "' + this.id + '", URL: "' + this.URL + '")');
    }
  ...
  WeexInstance.prototype.requireModule = function requireModule(moduleName) {
    ...
    if (!(id && this.document && this.document.taskCenter)) {
      console.error('[JS Framework] Failed to requireModule("' + moduleName + '"), ' + "instance (" + id + ") doesn't exist anymore.");
      return;
    }
  ...
  WeexInstance.prototype.importScript = function importScript(src, options) {
    ...
    return new Promise(function(resolve, reject) {
      if (!taskCenter || typeof taskCenter.send !== "function") {
        reject(new Error('[JS Framework] Failed to import script "' + src + '", ' + "no taskCenter (" + id + ") matched."));
      }
      try {
        taskCenter.send(
          "module",
  ...
  function createInstance(id, code, config, data) {
    ...
    if (bundleType === "Weex") {
      console.error("[JS Framework] COMPATIBILITY WARNING: " + "Weex DSL 1.0 (.we) framework is no longer supported! " + "It will be removed in the next version of WeexSDK, " + 'your page would be crash if you still using the ".we" framework. ' + "Please upgrade it to Vue.js or Rax.");
    }
    ...
    if (typeof framework.createInstance === "function") {
      ...
      if (bundleType === "Rax" || bundleType === "Weex") {
        ...
        const x = framework.createInstance(id, code, config, data, raxInstanceContext);
        console.log("...12123");
        return x;
      }
  ...
  function genInstance(methodName) {
    methods[methodName] = function() {
      ...
      return new Error("[JS Framework] Using invalid instance id " + '"' + id + '" when calling ' + methodName + ".");
      var ref;
    };
  }
  ...
  var config = {
    ...
    sendTasks: function sendTasks() {
      var args = [],
        len = arguments.length;
      while (len--) args[len] = arguments[len];
      // console.log(`sendTask: ${args[0]}`);
      if (typeof callNative === "function") {
        // console.log(`callNative: ${args}`);
  ...
  var runtime = {
    service: { register: register, unregister: unregister, has: has$1 },
  ...
  BroadcastChannel.prototype.postMessage = function(message) {
    ...
    if (subscribers && subscribers.length) {
      for (var i = 0; i < subscribers.length; ++i) {
        ...
        if (member._closed || member === this$1) {
          continue;
        }
  ...
  BroadcastChannel.prototype.close = function() {
    ...
    if (channels[this.name]) {
      var subscribers = channels[this.name].filter(function(x) {
        return x !== this$1;
      });
  ...
  var BroadcastChannel$1 = {
    ...
    destroy: function(id, env) {
      instances[id].forEach(function(channel) {
    ...
    var globalObjects = Object.assign(
      {
        ...
        sendTasks: function(tasks) {
          return config$2.sendTasks(id, tasks, -1);
        },
        options: options,
        document: document,
      },
  ...
  var factory = createCommonjsModule(function(module) {
    module.exports = function weexFactory(exports, document) {
      ...
      function getComponentState(vm) {
        ...
        var data = vm._data ? Object.assign({}, vm._data) : typeof _data === "function" ? getData(_data, vm) : _data || {};
        var computed = {};
      ...
      function initVirtualComponent(options) {
        ...
        registerComponentHook(componentId, "lifecycle", "attach", function(instance) {
          ...
          new Watcher(
            ...
            function() {
              return vm._update(vm._vnode, false);
            }
          );
        ...
        registerComponentHook(componentId, "lifecycle", "update", function(instance) {
          updateVirtualRef(vm, instance && instance.refs);
          vm._update(vm._vnode, false);
        });

        registerComponentHook(componentId, "lifecycle", "syncState", function(id, propsData) {
        ...
        registerComponentHook(componentId, "lifecycle", "detach", function(instance) {
      ...
      function renderRecyclableComponentTemplate(vnode) {
        ...
        if (render) {
          ...
          warn("@render function not defined on component used in <recycle-list>. " + 'Make sure to declare `recyclable="true"` on the component\'s template.', vm);
        }
      }
      ...
      function initRender(vm) {
        ...
        vm._c = function(a, b, c, d) {
                                     console.log(`function(a, b, c, d): ${b.staticStyle}`);
      ...
      function add$1(event, handler, once, capture, passive, params) {
        if (capture) {
      ...
      function createStyle(oldVnode, vnode) {
        ...
        console.log(`createStyle: ${staticStyle}`);
        if (supportBatchUpdate) {
      ...
      function getEnterTargetState(el, stylesheet, startClass, endClass, activeClass, vm) {
        ...
        if (startState) {
          for (var key in startState) {
            ...
            if ("development" !== "production" && targetState[key] == null && (!activeState || activeState[key] == null) && (!endState || endState[key] == null)) {
              warn('transition property "' + key + '" is declared in enter starting class (.' + startClass + "), " + "but not declared anywhere in enter ending class (." + endClass + "), " + "enter active cass (." + activeClass + ") or the element's default styling. " + "Note in Weex, CSS properties need explicit values to be transitionable.");
            }
          }
        }
      ...
      function interceptArrayMethods(vm, array) {
        ...
        for (var i = 0, n = arrayKeys$1.length; i < n; i++) {
          loop(i, n);
        }
      }
        ...
        render: function render(h) {
          ...
          if (parent && exp) {
            ...
            parent.$watch(
              exp,
              function() {
                return def(this$1.$options, "[[UseCache]]", true);
              },
  ...
  var weexVueFramework = createCommonjsModule(function(module, exports) {
    ...
    function createVueModuleInstance(instanceId, weex) {
      ...
      Vue.config.isReservedTag = function(name) {
        return (!isRuntimeComponent(name) && weex.supports("@component/" + name)) || isReservedTag(name) || weexRegex.test(name);
      };
  ...
  var isWeexComponent = function(name) {
    return !!name.match(WEEX_COMPONENT_REG);
  };
  var isWeexModule = function(name) {
    return !!name.match(WEEX_MODULE_REG);
  };
  var isNormalModule = function(name) {
    return !!name.match(NORMAL_MODULE_REG);
  };
  var isNpmModule = function(name) {
  ...
  Watcher.prototype.run = function() {
    if (this.active) {
      ...
      if (
        ...
        ((isObject$1(value) || this.deep) && !this.shallow)
      ) {
        // set new value
        var oldValue = this.value;
        this.value = value;
  ...
  def$1(arrayProto, "$set", function $set(index, val) {
    console.warn('[JS Framework] "Array.prototype.$set" is not a standard API,' + " it will be removed in the next version.");
  ...
  def$1(arrayProto, "$remove", function $remove(index) {
    console.warn('[JS Framework] "Array.prototype.$remove" is not a standard API,' + " it will be removed in the next version.");
    /* istanbul ignore if */
    if (!this.length) {
      return;
    }
  ...
  function observe(value, vm) {
    ...
    if (hasOwn$1(value, "__ob__") && value.__ob__ instanceof Observer$1) {
      ob = value.__ob__;
    } else if ((Array.isArray(value) || isPlainObject$1(value)) && Object.isExtensible(value) && !value._isVue) {
  ...
  function applyNaitveComponentOptions(template) {
    ...
    if (typeof options === "object") {
      for (var key in options) {
        ...
        } else if (typof$1(template[key]) === "object" && typof$1(options[key]) === "object") {
  ...
  var semver = createCommonjsModule(function(module, exports) {
    ...
    /* nomin */ var debug;
    /* nomin */ if (typeof process === "object" && /* nomin */ process.env && /* nomin */ false && /* nomin */ /\bsemver\b/i.test(false)) {
  ...
  function check(config, deviceInfo) {
    ...
    deviceInfo = isPlainObject$1(deviceInfo) ? deviceInfo : {};
    ...
    if (typof$1(config) === "function") {
      ...
      config = isPlainObject$1(config) ? config : {};
  ...
  function bootstrap(app, name, config, data) {
    ...
    if (typeof config.transformerVersion === "string" && typeof global.transformerVersion === "string" && !semver.satisfies(config.transformerVersion, global.transformerVersion)) {
  ...
  function init$3(app, code, data, services) {
    ...
    /* istanbul ignore next */
    var bundleRequire = function(name) {
    ...
    /* istanbul ignore next */
    var bundleRequireModule = function(name) {
      return app.requireModule(removeWeexPrefix(name));
    };
  ...
  function App$1(id, options) {
    ...
    // document
    this.doc = new config$3.Document(id, this.options.bundleUrl, null, config$3.Listener);
        ...
        /***/ function(module, exports, __webpack_require__) {
          var createUniqueKey = (module.exports.createUniqueKey =
            typeof Symbol !== "undefined"
              ? Symbol //eslint-disable-line no-undef
              ...
              var _loop = function _loop(name) {
                ...
                NativeModules[name].forEach(function(method) {
                  ...
                  modules[moduleName].module.exports[methodName] = function() {
                    ...
                    return document.taskCenter.send(
                      "module",
                      {
                        module: name,
                        method: methodName,
              ...
              /******/ [
                ...
                /***/ function(module, exports, __webpack_require__) {
                  ...
                  function makeIterator(mapInst, getter) {
                    ...
                    return {
                      next: function next() {
                        if (nextIdx === mapInst._keys.length) {
                          done = true;
                        }
                        if (!done) {
                  ...
                  function calcSize(mapInst) {
                    ...
                    for (var i = 0, s = mapInst._keys.length; i < s; i++) {
                      if (mapInst._keys[i] !== undefMarker) {
                        size++;
                      }
                    }
                    return size;
                ...
                /***/ function(module, exports, __webpack_require__) {
                  ...
                  function calcSize(setInst) {
                    ...
                    for (var i = 0, s = setInst._values.length; i < s; i++) {
                      if (setInst._values[i] !== undefMarker) {
                        size++;
                      }
                    }
                    return size;
                ...
                /***/ function(module, exports, __webpack_require__) {
                  ...
                  WeakMap.prototype.set = function(key, value) {
                    if ((typeof key === "undefined" ? "undefined" : _typeof(key)) !== "object" && typeof key !== "function") {
                ...
                /***/ function(module, exports, __webpack_require__) {
                  ...
                  WeakSet.prototype.add = function(obj) {
                    var name = this.name;
                    if (!obj[name]) {
                      Object.defineProperty(obj, name, { value: true, writable: true });
                    }
                    return this;
                  };
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          module.exports = function(responseEnd) {
            ...
            performance.timing =
              ...
              _defineProperty(_performance$timing, "connectStart", responseEnd),
              _defineProperty(_performance$timing, "requestStart", responseEnd),
              _defineProperty(_performance$timing, "responseStart", responseEnd),
              _defineProperty(_performance$timing, "responseEnd", responseEnd),
              _defineProperty(_performance$timing, "domLoading", 0),
              _defineProperty(_performance$timing, "domInteractive", 0),
              _defineProperty(_performance$timing, "domComplete", 0),
              _defineProperty(_performance$timing, "domContentLoadedEventStart", 0),
              _defineProperty(_performance$timing, "domContentLoadedEventEnd", 0),
              _defineProperty(_performance$timing, "loadEventStart", 0),
              _defineProperty(_performance$timing, "loadEventEnd", 0),
              _performance$timing);
